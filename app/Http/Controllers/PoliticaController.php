...
class PoliticaController extends Controller
{
    public function index(){
        ...
        return view('politica.new_politica');
        }
        ...
        public function edit($id){
            ...
            /*$empresa = politica::findOrFail($id);
            $empresa = politica::where('id', $id)->first();

            return view('politica.edit_empresa', [
                'empresa' => $empresa,
            ]);*/
        }
        ...
        public function store(Request $request){
            ...
            $request->validate(
                [
                    ...
                    'telefono_empresa'=>'required|numeric|unique:politica,telefono',
