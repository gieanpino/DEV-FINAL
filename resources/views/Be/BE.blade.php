...
<div class="col justify-content-left">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ url('/actascocola') }}">módulo de actas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/planAnualcocola') }}">plan anual</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row justify-content-center">
       <div class="col" style="width: 750px;">
            <div class="card m-lg-3" >
                <div class="card-header">{{ __('Presidente de brigada de emergencia (BE)')}}</div>
