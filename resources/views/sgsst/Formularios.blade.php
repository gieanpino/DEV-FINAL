...
<div class="row " id="main">
    ...
    <div class="col-12">
        <button type="button" class="btn col-9 bg-info btn-lg m-2" data-toggle="modal" data-target="#crearUsuario">Crear usuario </button>
    </div>
    <div class="col-12">
        <button type="button" class="btn col-9 bg-primary btn-lg m-2" data-toggle="modal" data-target="#crearEmpresa">Crear Empresa </button>
    </div>
